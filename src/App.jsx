...
export default function App() {
  const [movie_info, setMovie_info] = useState(movie_trailer);
  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <Paper className="pap" sx={bgstyle} elevation={8}>
        <div className="movie_display">
          ...
          <Routes>
            ...
            ></Route>
            <Route path="/tic" element={<TicTak />}></Route>
            <Route
              path="/movies/:id"
              element={<MovieDet movie_info={movie_info} />}
            ></Route>
            <Route
              path="/movie/add"
              element={
